...
class ExportEventsRequestBodyFilters:
    r"""ExportEventsRequestBodyFilters
...
class ExportEventsRequestBody:
    ...
    filters: Optional[ExportEventsRequestBodyFilters] = dataclasses.field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('filters') }})
...
class ExportEventsRequest:
    request: Optional[ExportEventsRequestBody] = dataclasses.field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass_json
@dataclasses.dataclass
class ExportEventsMessageGeneralResponse:
...
@dataclasses.dataclass
class ExportEventsResponse:
    content_type: str = dataclasses.field()
    status_code: int = dataclasses.field()
    bulk_export_response: Optional[shared_bulkexportresponse.BulkExportResponse] = dataclasses.field(default=None)
    message_general_response: Optional[ExportEventsMessageGeneralResponse] = dataclasses.field(default=None)
