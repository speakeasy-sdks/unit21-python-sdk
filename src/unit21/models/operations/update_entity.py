...
@dataclass_json
@dataclasses.dataclass
class UpdateEntityMessageGeneralResponse:
...
class UpdateEntityResponse:
    ...
    message_general_response: Optional[UpdateEntityMessageGeneralResponse] = dataclasses.field(default=None)
    update_entity_response: Optional[Any] = dataclasses.field(default=None)
